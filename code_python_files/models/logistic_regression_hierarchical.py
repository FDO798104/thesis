# -*- coding: utf-8 -*-
"""BetterHierarchicalLogReg.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mR7LUBcOR7KM2b8xiIHI6B9UBznr0x48
"""
...
def select_directory(use_directory):
  ...
  if use_directory == 1:
    data_directory = '/content/drive/.../dataset2A' # change paths
  elif use_directory == 2:
    data_directory = '/content/drive/.../dataset2D'
  elif use_directory == 3:
    data_directory = '/content/drive/.../dataset1'
  elif use_directory == 4:
    data_directory = '/content/drive/.../dataset3'
  elif use_directory == 5:
    data_directory = '/content/drive/.../dataset2E'
  elif use_directory == 6:
    data_directory = '/content/drive/.../dataset2F'
  elif use_directory == 7:
    data_directory = '/content/drive/.../dataset2C'
  elif use_directory == 8:
    data_directory = '/content/drive/.../dataset2B'
  elif use_directory == 9:
    data_directory = '/content/drive/.../dataset2G'
  else:
...
if __name__ == "__main__":
    '''
      base_folder
      In this folder a new folder for each experiment will be created with the
      models stored per hierarchy level
    '''
    base_folder = '/content/drive/MyDrive/Thesis/models/Logistic_regression/models_test_code_final/'

    '''
      results_folder
      In this folder the confusion matrices will be saved
      It is best not to make this folder the same as base_folder
    '''
    # folder were results of each experiment will be stored (for easy accessibility make sure this folder differs from base folder)
    results_folder = '/content/drive/MyDrive/Thesis/models/Logistic_regression/results_test_code_final/'

    '''
      results_file
      This should be an .xlsx file. In this file the results for every
    ...
    '''
      apply_downsampling_on_first_number
      Two options, True and False to vary downsampling on first number in experiments
    '''

    '''
      use_class_weighting_options
      Two options, True and False to vary class weighting
    '''
    use_class_weighting_options = [True, False] # use class weighting?

    '''
      use_embeddings_options
      Two options, True and False to vary using embedding
      (True will only be applied on Full Words on pre processed dataset 1)
    '''
    use_embeddings_options = [True, False] # use embeddings options

    '''
      pre_selected_use_directory_options
      Which pre processed file folders
    '''
    ...
    # keep as is\/
    apply_downsampling_on_first_number = [True, False] #6660 - 100000000
    random_state_values = [32] # keep
    tf_idf_max_features_options = [50000] # keep
    iterations_max_options = [1000] # keep - all models converge long before 1000 iteration
    max_instances_options = []
    if True in apply_downsampling_on_first_number:
      max_instances_options.append[6660]
    if False in apply_downsampling_on_first_number:
      max_instances_options.append[100000000]
